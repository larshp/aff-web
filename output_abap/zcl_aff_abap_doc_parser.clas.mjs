...
class zcl_aff_abap_doc_parser {
  ...
  async check_title_positions() {
    ...
    if ((abap.compare.gt(abap.builtin.count({val: this.abap_doc_string, regex: zcl_aff_abap_doc_parser.co_shorttext_tag_open}), new abap.types.Integer().set(1)))) {
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(107), msgv1: new abap.types.String().set(`'Title'`)})));
      await this.parser_log.get().zif_aff_log$add_info({message_text: msg, component_name: this.component_name});
    }
    if ((abap.compare.gt(abap.builtin.find({val: this.abap_doc_string, regex: zcl_aff_abap_doc_parser.co_shorttext_tag_open}), new abap.types.Integer().set(0)))) {
  ...
  async workaround_remove_titles() {
    ...
    while ((abap.compare.eq(abap.builtin.boolc({val: abap.builtin.matches({val: this.abap_doc_string, regex: new abap.types.String().set(`.*[\\s]*<p\\sclass="shorttext">.*`)})}), abap.builtin.abap_true))) {
      ...
      start_offset.set(abap.builtin.find({val: this.abap_doc_string, regex: zcl_aff_abap_doc_parser.co_shorttext_tag_open, occ: new abap.types.Integer().set(1)}));
  ...
  async parse_annotations() {
    let result_table = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"), {"withHeader":false}, "MATCH_RESULT_TAB");
    let modified_abap_doc_string = new abap.types.String({qualifiedName: "STRING"});
    let fs_entry_ = new abap.types.FieldSymbol(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"));
    ...
    let temp1 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    ...
    for await (const unique3 of abap.statements.loop(result_table)) {
      ...
      if (abap.compare.eq(unique4, zcl_aff_abap_doc_parser.abap_doc_annotation.get().callback_class)) {
        ...
        abap.statements.replace({target: modified_abap_doc_string, all: false, with: new abap.types.Character(0).set(''), of: key_word});
        temp1.set(key_word);
        msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(108), msgv1: temp1})));
  ...
  async parse_callback_class() {
    ...
    let result_table = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"), {"withHeader":false}, "MATCH_RESULT_TAB");
    let temp2 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    let offset_found = new abap.types.Integer({qualifiedName: "I"});
    let temp1 = new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT");
    let temp3 = new abap.types.Integer();
    let length_found = new abap.types.Integer({qualifiedName: "I"});
    let temp4 = new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT");
    ...
    if (abap.compare.eq(abap.builtin.lines({val: result_table}), new abap.types.Integer().set(0))) {
      temp2.set(zcl_aff_abap_doc_parser.abap_doc_annotation.get().callback_class);
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(109), msgv1: temp2})));
      await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
      return;
    }
    ...
    abap.statements.readTable(result_table,{index: new abap.types.Integer().set(1),into: temp1});
    ...
    abap.statements.readTable(result_table,{index: new abap.types.Integer().set(1),into: temp4});
    abap.builtin.sy.get().tabix.set(temp5);
    if (abap.compare.ne(abap.builtin.sy.get().subrc, new abap.types.Integer().set(0))) {
      throw await (new abap.Classes['CX_SY_ITAB_LINE_NOT_FOUND']()).constructor_();
    }
    length_found.set(temp4.get().length);
    this.decoded_abap_doc.get().callback_class.set((await this.get_annotation_value({length: abap.operators.minus(length_found,new abap.types.Integer().set(1)), offset: offset_found, to_decode: string_to_parse, length_of_annotation: new abap.types.Integer().set(20), remove_whitespaces: abap.builtin.abap_true})));
    for await (const unique5 of abap.statements.loop(result_table)) {
      fs_entry_.assign(unique5);
  ...
  async get_annotation_value(INPUT) {
    ...
    let remove_whitespaces = new abap.types.Character(1, {"qualifiedName":"ABAP_BOOLEAN","ddicName":"ABAP_BOOLEAN"});
  ...
  async parse_default() {
    let string_to_parse = new abap.types.String({qualifiedName: "STRING"});
    let result_table_value = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"), {"withHeader":false}, "MATCH_RESULT_TAB");
    let result_table_link = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"), {"withHeader":false}, "MATCH_RESULT_TAB");
    let mixed_result_table = new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>TY_MIXED_TABLE_ENTRY-OFFSET"}), "length": new abap.types.Integer({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>TY_MIXED_TABLE_ENTRY-LENGTH"}), "is_link": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOLEAN","ddicName":"ABAP_BOOLEAN"})}, "zcl_aff_abap_doc_parser=>ty_mixed_table_entry"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["OFFSET"]},"secondary":[]}, "zcl_aff_abap_doc_parser=>tt_mixed_table_entry");
    let fs_default_value_ = new abap.types.FieldSymbol(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"));
    let temp3 = new abap.types.Structure({"offset": new abap.types.Integer({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>TY_MIXED_TABLE_ENTRY-OFFSET"}), "length": new abap.types.Integer({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>TY_MIXED_TABLE_ENTRY-LENGTH"}), "is_link": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOLEAN","ddicName":"ABAP_BOOLEAN"})}, "zcl_aff_abap_doc_parser=>ty_mixed_table_entry");
    let fs_default_link_ = new abap.types.FieldSymbol(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"));
    ...
    let temp5 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    let temp6 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    ...
    let splitted = new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "");
    let temp7 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    ...
    for await (const unique6 of abap.statements.loop(result_table_value)) {
      fs_default_value_.assign(unique6);
    ...
    for await (const unique7 of abap.statements.loop(result_table_link)) {
      fs_default_link_.assign(unique7);
    ...
    if (abap.compare.eq(abap.builtin.lines({val: mixed_result_table}), new abap.types.Integer().set(0))) {
      temp5.set(zcl_aff_abap_doc_parser.abap_doc_annotation.get().default_);
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(109), msgv1: temp5})));
      await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
      return;
    }
    if (abap.compare.gt(abap.builtin.lines({val: mixed_result_table}), new abap.types.Integer().set(1))) {
      temp6.set(zcl_aff_abap_doc_parser.abap_doc_annotation.get().default_);
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(107), msgv1: temp6})));
      await this.parser_log.get().zif_aff_log$add_info({message_text: msg, component_name: this.component_name});
    }
    warning_set.set(abap.builtin.abap_false);
    for await (const unique8 of abap.statements.loop(mixed_result_table)) {
      ...
      if (abap.compare.eq(fs_entry_.get().is_link, abap.builtin.abap_false) && abap.compare.initial(this.decoded_abap_doc.get().default_)) {
        this.decoded_abap_doc.get().default_.set(abap.operators.concat(new abap.types.String().set(`"`),abap.operators.concat((await this.get_annotation_value({length: abap.operators.minus(fs_entry_.get().length,new abap.types.Integer().set(1)), offset: fs_entry_.get().offset, to_decode: string_to_parse, length_of_annotation: new abap.types.Integer().set(9), remove_whitespaces: abap.builtin.abap_false})),new abap.types.String().set(`"`))));
        ...
        link.set((await this.get_annotation_value({length: abap.operators.minus(fs_entry_.get().length,new abap.types.Integer().set(1)), offset: fs_entry_.get().offset, to_decode: string_to_parse, length_of_annotation: new abap.types.Integer().set(9), remove_whitespaces: abap.builtin.abap_true})));
        ...
        if (abap.compare.eq(abap.builtin.lines({val: splitted}), new abap.types.Integer().set(3))) {
          ...
          msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(111), msgv1: temp7})));
          await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
  ...
  async parse_enum_values() {
    let string_to_parse = new abap.types.String({qualifiedName: "STRING"});
    let result_table = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"), {"withHeader":false}, "MATCH_RESULT_TAB");
    let temp8 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    let warning_written = new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"});
    let fs_entry_ = new abap.types.FieldSymbol(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"));
    let offset_found = new abap.types.Integer();
    let length_found = new abap.types.Integer();
    let link = new abap.types.String({qualifiedName: "STRING"});
    let link_for_testing = new abap.types.String({qualifiedName: "STRING"});
    let splitted = new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "");
    let temp9 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    ...
    if (abap.compare.eq(abap.builtin.lines({val: result_table}), new abap.types.Integer().set(0))) {
      ...
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(109), msgv1: temp8})));
      await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
      return;
    }
    ...
    for await (const unique9 of abap.statements.loop(result_table)) {
      ...
      link.set((await this.get_annotation_value({length: abap.operators.minus(length_found,new abap.types.Integer().set(1)), offset: offset_found, to_decode: string_to_parse, length_of_annotation: new abap.types.Integer().set(13), remove_whitespaces: abap.builtin.abap_true})));
      ...
      abap.statements.split({source: link_for_testing, at: new abap.types.Character(1).set('.'), table: splitted});
      if (abap.compare.eq(abap.builtin.lines({val: splitted}), new abap.types.Integer().set(2)) && abap.compare.initial(this.decoded_abap_doc.get().enumvalues_link)) {
        this.decoded_abap_doc.get().enumvalues_link.set(link);
      } else if (abap.compare.ne(abap.builtin.lines({val: splitted}), new abap.types.Integer().set(2)) && abap.compare.eq(warning_written, abap.builtin.abap_false)) {
        temp9.set(zcl_aff_abap_doc_parser.abap_doc_annotation.get().values);
        msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(111), msgv1: temp9})));
        await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
  ...
  async parse_number_annotations(INPUT) {
    ...
    let unique12 = key_word;
    if (abap.compare.eq(unique12, zcl_aff_abap_doc_parser.abap_doc_annotation.get().minimum)) {
    ...
    } else if (abap.compare.eq(unique12, zcl_aff_abap_doc_parser.abap_doc_annotation.get().maximum)) {
    ...
    } else if (abap.compare.eq(unique12, zcl_aff_abap_doc_parser.abap_doc_annotation.get().exclusive_minimum)) {
    ...
    } else if (abap.compare.eq(unique12, zcl_aff_abap_doc_parser.abap_doc_annotation.get().exclusive_maximum)) {
    ...
    } else if (abap.compare.eq(unique12, zcl_aff_abap_doc_parser.abap_doc_annotation.get().multiple_of)) {
    ...
    } else if (abap.compare.eq(unique12, zcl_aff_abap_doc_parser.abap_doc_annotation.get().min_length)) {
    ...
    } else if (abap.compare.eq(unique12, zcl_aff_abap_doc_parser.abap_doc_annotation.get().max_length)) {
  ...
  async get_number_annotation(INPUT) {
    ...
    let result_table = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"), {"withHeader":false}, "MATCH_RESULT_TAB");
    let temp10 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    ...
    let temp11 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    ...
    if (abap.compare.eq(abap.builtin.lines({val: result_table}), new abap.types.Integer().set(0))) {
      ...
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(109), msgv1: temp10})));
      await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
      return number;
    }
    ...
    for await (const unique13 of abap.statements.loop(result_table)) {
      ...
      if (abap.compare.eq(match, abap.builtin.abap_true) && abap.compare.initial(number)) {
        ...
        msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(110), msgv1: temp11})));
        await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
        warning_written.set(abap.builtin.abap_true);
      }
    }
  ...
  async parse_enum_value() {
    let string_to_parse = new abap.types.String({qualifiedName: "STRING"});
    let result_table = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT"), {"withHeader":false}, "MATCH_RESULT_TAB");
    let temp12 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    let offset_found = new abap.types.Integer({qualifiedName: "I"});
    let temp6 = new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT");
    let temp7 = new abap.types.Integer();
    let length_found = new abap.types.Integer({qualifiedName: "I"});
    let temp8 = new abap.types.Structure({"line": new abap.types.Integer(), "offset": new abap.types.Integer(), "length": new abap.types.Integer(), "submatches": new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer(), "length": new abap.types.Integer()}, "SUBMATCH_RESULT"), {"withHeader":false}, "SUBMATCH_RESULT_TAB")}, "MATCH_RESULT");
    ...
    if (abap.compare.eq(abap.builtin.lines({val: result_table}), new abap.types.Integer().set(0))) {
      ...
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(109), msgv1: temp12})));
      await this.parser_log.get().zif_aff_log$add_warning({message_text: msg, component_name: this.component_name});
      return;
    }
    ...
    abap.statements.readTable(result_table,{index: new abap.types.Integer().set(1),into: temp6});
    ...
    abap.statements.readTable(result_table,{index: new abap.types.Integer().set(1),into: temp8});
    abap.builtin.sy.get().tabix.set(temp9);
    if (abap.compare.ne(abap.builtin.sy.get().subrc, new abap.types.Integer().set(0))) {
      throw await (new abap.Classes['CX_SY_ITAB_LINE_NOT_FOUND']()).constructor_();
    }
    length_found.set(temp8.get().length);
    this.decoded_abap_doc.get().enum_value.set((await this.get_annotation_value({length: abap.operators.minus(length_found,new abap.types.Integer().set(1)), offset: offset_found, to_decode: string_to_parse, length_of_annotation: new abap.types.Integer().set(11), remove_whitespaces: abap.builtin.abap_true})));
    for await (const unique14 of abap.statements.loop(result_table)) {
      fs_entry_.assign(unique14);
      await this.check_next_word({offset: abap.operators.add(fs_entry_.get().offset,fs_entry_.get().length), text_to_check: string_to_parse});
    }
  }
  ...
  async check_next_word(INPUT) {
    ...
    while (abap.compare.eq(next_char, abap.builtin.space) && abap.compare.lt(current_offset, abap.builtin.strlen({val: text_to_check}))) {
      abap.builtin.sy.get().index.set(unique15++);
      next_char.set(text_to_check.getOffset({offset: current_offset, length: 1}));
      current_offset.set(abap.operators.add(current_offset,new abap.types.Integer().set(1)));
    }
    abap.builtin.sy.get().index.set(indexBackup1);
    ...
    let unique16 = 1;
    while (true) {
      abap.builtin.sy.get().index.set(unique16++);
      next_char.set(text_to_check.getOffset({offset: current_offset, length: 1}));
      current_offset.set(abap.operators.add(current_offset,new abap.types.Integer().set(1)));
    ...
    if (abap.compare.eq(abap.builtin.strlen({val: next_word}), new abap.types.Integer().set(1)) || abap.compare.ne(next_word.getOffset({offset: 0, length: 1}), new abap.types.String().set(`$`))) {
  ...
  async write_log_for_multiple_entries(INPUT) {
    ...
    let temp13 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    if (abap.compare.gt(abap.builtin.lines({val: result_table}), new abap.types.Integer().set(1))) {
      temp13.set(annotaion);
      msg.set((await this.parser_log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(107), msgv1: temp13})));
      await this.parser_log.get().zif_aff_log$add_info({message_text: msg, component_name: this.component_name});
    }
  }
}
...
zcl_aff_abap_doc_parser.tt_mixed_table_entry = new abap.types.Table(new abap.types.Structure({"offset": new abap.types.Integer({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>TY_MIXED_TABLE_ENTRY-OFFSET"}), "length": new abap.types.Integer({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>TY_MIXED_TABLE_ENTRY-LENGTH"}), "is_link": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOLEAN","ddicName":"ABAP_BOOLEAN"})}, "zcl_aff_abap_doc_parser=>ty_mixed_table_entry"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"SORTED","isUnique":true,"keyFields":["OFFSET"]},"secondary":[]}, "zcl_aff_abap_doc_parser=>tt_mixed_table_entry");
