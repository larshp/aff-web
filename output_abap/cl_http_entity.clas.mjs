...
class cl_http_entity {
  ...
  async constructor_(INPUT) {
    ...
    this.mt_headers = new abap.types.Table(new abap.types.Structure({"name": new abap.types.String(), "value": new abap.types.String()}, "IHTTPNVP"), {"withHeader":false}, "TIHTTPNVP");
    this.mt_form_fields = new abap.types.Table(new abap.types.Structure({"name": new abap.types.String(), "value": new abap.types.String()}, "IHTTPNVP"), {"withHeader":false}, "TIHTTPNVP");
    return this;
  }
  async if_http_response$server_cache_expire_rel(INPUT) {
    ...
    let browser_dependent = new abap.types.Character(1, {"qualifiedName":"BOOLEAN"});
    if (INPUT && INPUT.browser_dependent) {browser_dependent = INPUT.browser_dependent;}
    if (INPUT === undefined || INPUT.browser_dependent === undefined) {browser_dependent = new abap.types.Character(1).set(' ');}
    let no_ufo_cache = new abap.types.Character(1, {"qualifiedName":"BOOLEAN"});
    if (INPUT && INPUT.no_ufo_cache) {no_ufo_cache = INPUT.no_ufo_cache;}
    if (INPUT === undefined || INPUT.no_ufo_cache === undefined) {no_ufo_cache = new abap.types.Character(1).set(' ');}
  ...
  async if_http_response$server_cache_browser_dependent(INPUT) {
    let dependent = new abap.types.Character(1, {"qualifiedName":"BOOLEAN"});
    if (INPUT && INPUT.dependent) {dependent = INPUT.dependent;}
    if (INPUT === undefined || INPUT.dependent === undefined) {dependent = new abap.types.Character(1).set('X');}
    abap.statements.assert(abap.compare.eq(new abap.types.Integer().set(1), new abap.types.Character(4).set('todo')));
  }
  ...
  async if_http_entity$get_header_fields(INPUT) {
    let fields = new abap.types.Character(4);
