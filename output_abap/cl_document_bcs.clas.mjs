...
class cl_document_bcs {
  ...
  async add_attachment(INPUT) {
    ...
    let i_attachment_header = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Character(255, {"qualifiedName":"SO_TEXT255","ddicName":"SO_TEXT255"})}, "SOLI"), {"withHeader":false}, "SOLI_TAB");
