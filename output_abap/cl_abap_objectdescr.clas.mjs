...
class cl_abap_objectdescr extends cl_abap_typedescr {
  ...
  async constructor_(INPUT) {
    ...
    this.me.set(this);
    this.attributes = new abap.types.Table(new abap.types.Structure({length: new abap.types.Integer({qualifiedName: "LENGTH"}), decimals: new abap.types.Integer({qualifiedName: "DECIMALS"}), name: new abap.types.Character({length: 61, qualifiedName: "abap_attrname"}), type_kind: new abap.types.Character({qualifiedName: "abap_typekind"}), visibility: new abap.types.Character({qualifiedName: "abap_visibility"}), is_interface: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_inherited: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_class: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_constant: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_virtual: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_read_only: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), alias_for: new abap.types.Character({length: 61, qualifiedName: "abap_attrname"})}, "abap_attrdescr"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":["NAME"]}, "abap_attrdescr_tab");
    this.methods = new abap.types.Table(new abap.types.Structure({parameters: new abap.types.Table(new abap.types.Structure({length: new abap.types.Integer({qualifiedName: "LENGTH"}), decimals: new abap.types.Integer({qualifiedName: "DECIMALS"}), type_kind: new abap.types.Character({qualifiedName: "abap_typekind"}), name: new abap.types.Character({length: 30, qualifiedName: "abap_parmname"}), parm_kind: new abap.types.Character({qualifiedName: "abap_parmkind"}), by_value: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_optional: new abap.types.Character({qualifiedName: "ABAP_BOOL"})}, "abap_parmdescr"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":["NAME"]}, "abap_parmdescr_tab"), exceptions: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "abap_excpname"}), is_resumable: new abap.types.Character({qualifiedName: "ABAP_BOOL"})}, "abap_excpdescr"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":["NAME"]}, "abap_excpdescr_tab"), name: new abap.types.Character({length: 61, qualifiedName: "abap_methname"}), for_event: new abap.types.Character({length: 61, qualifiedName: "abap_evntname"}), of_class: new abap.types.Character({length: 30, qualifiedName: "abap_classname"}), visibility: new abap.types.Character({qualifiedName: "abap_visibility"}), is_interface: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_inherited: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_redefined: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_abstract: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_final: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), is_class: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), alias_for: new abap.types.Character({length: 61, qualifiedName: "abap_methname"}), is_raising_excps: new abap.types.Character({qualifiedName: "ABAP_BOOL"})}, "abap_methdescr"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":["NAME"]}, "abap_methdescr_tab");
    this.interfaces = new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "abap_intfname"}), is_inherited: new abap.types.Character({qualifiedName: "ABAP_BOOL"})}, "abap_intfdescr"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":["NAME"]}, "abap_intfdescr_tab");
  ...
  async get_method_parameter_type(INPUT) {
    ...
    let p_method_name = new abap.types.Character({length: 4});
    if (INPUT && INPUT.p_method_name) {p_method_name = INPUT.p_method_name;}
    let p_parameter_name = new abap.types.Character({length: 4});
