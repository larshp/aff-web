...
class cl_abap_datfm {
  ...
  static async conv_date_ext_to_int(INPUT) {
    ...
    if (abap.compare.ne(im_datfmdes, cl_abap_datfm.ddmmyyyy_dot_seperated) && abap.compare.ne(im_datfmdes, cl_abap_datfm.yyyymmdd_dot_seperated)) {
      const unique175 = await (new abap.Classes['CX_ABAP_DATFM']()).constructor_();
      unique175.EXTRA_CX = {"INTERNAL_FILENAME": "cl_abap_datfm.clas.abap","INTERNAL_LINE": 50};
      throw unique175;
    }
    ...
    const unique176 = await (new abap.Classes['CX_ABAP_DATFM']()).constructor_();
    unique176.EXTRA_CX = {"INTERNAL_FILENAME": "cl_abap_datfm.clas.abap","INTERNAL_LINE": 74};
    throw unique176;
  }
