...
class kernel_numberrange {
  ...
  static async number_get(INPUT) {
    ...
    let fs_row_ = new abap.types.FieldSymbol(new abap.types.Structure({"nr_range_nr": new abap.types.Character(2, {"qualifiedName":"kernel_numberrange=>ty_status-nr_range_nr"}), "object": new abap.types.Character(10, {"qualifiedName":"kernel_numberrange=>ty_status-object"}), "number": new abap.types.Numc({length: 20, qualifiedName: "cl_numberrange_runtime=>nr_number"})}, "kernel_numberrange=>ty_status"));
...
kernel_numberrange.status = new abap.types.Table(new abap.types.Structure({"nr_range_nr": new abap.types.Character(2, {"qualifiedName":"kernel_numberrange=>ty_status-nr_range_nr"}), "object": new abap.types.Character(10, {"qualifiedName":"kernel_numberrange=>ty_status-object"}), "number": new abap.types.Numc({length: 20, qualifiedName: "cl_numberrange_runtime=>nr_number"})}, "kernel_numberrange=>ty_status"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "");
kernel_numberrange.ty_status = new abap.types.Structure({"nr_range_nr": new abap.types.Character(2, {"qualifiedName":"kernel_numberrange=>ty_status-nr_range_nr"}), "object": new abap.types.Character(10, {"qualifiedName":"kernel_numberrange=>ty_status-object"}), "number": new abap.types.Numc({length: 20, qualifiedName: "cl_numberrange_runtime=>nr_number"})}, "kernel_numberrange=>ty_status");
