...
class cl_abap_exceptional_values {
  ...
  static async get_max_value(INPUT) {
    ...
    let unique150 = lv_type;
    if (abap.compare.eq(unique150, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int)) {
      out.assign(abap.Classes['CL_ABAP_MATH'].max_int4);
    } else if (abap.compare.eq(unique150, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_packed)) {
  ...
  static async get_min_value(INPUT) {
    ...
    if (abap.compare.eq(unique151, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int)) {
      out.assign(abap.Classes['CL_ABAP_MATH'].min_int4);
    } else if (abap.compare.eq(unique151, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_packed)) {
