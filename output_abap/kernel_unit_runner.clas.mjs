...
class kernel_unit_runner {
  ...
  static async get_location(INPUT) {
    ...
    let lt_lines = new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "");
    ...
    for await (const unique168 of abap.statements.loop(lt_lines)) {
      lv_stack.set(unique168);
      if (abap.compare.cp(lv_stack, new abap.types.Character(21).set('*cl_abap_unit_assert*'))) {
        ...
        abap.statements.replace({target: lv_stack, all: false, with: new abap.types.Character(0).set(''), of: new abap.types.String().set(`at `)});
  ...
  static async to_json(INPUT) {
    ...
    let lt_strings = new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "");
    let lv_string = new abap.types.String({qualifiedName: "STRING"});
    let lv_message = new abap.types.String({qualifiedName: "STRING"});
    for await (const unique169 of abap.statements.loop(it_list)) {
      ls_list.set(unique169);
  ...
  static async unique_classes(INPUT) {
    let rt_classes = new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-testclass_name"})}, "kernel_unit_runner=>ty_class_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_classes");
    let it_input = new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-testclass_name"}), "method_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-method_name"})}, "kernel_unit_runner=>ty_input_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_input");
    ...
    for await (const unique170 of abap.statements.loop(it_input)) {
      ls_input.set(unique170);
  ...
  static async run(INPUT) {
    let rs_result = new abap.types.Structure({"list": new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-testclass_name"}), "method_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-method_name"}), "expected": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-EXPECTED"}), "actual": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-ACTUAL"}), "status": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_STATUS"}), "runtime": new abap.types.Integer({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-RUNTIME"}), "message": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-MESSAGE"}), "js_location": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-JS_LOCATION"})}, "kernel_unit_runner=>ty_result_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_result-list"), "json": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT-JSON"})}, "kernel_unit_runner=>ty_result");
    let it_input = new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-testclass_name"}), "method_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-method_name"})}, "kernel_unit_runner=>ty_input_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_input");
    if (INPUT && INPUT.it_input) {it_input.set(INPUT.it_input);}
    let ls_input = new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-testclass_name"}), "method_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-method_name"})}, "kernel_unit_runner=>ty_input_item");
    ...
    let lt_classes = new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-testclass_name"})}, "kernel_unit_runner=>ty_class_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_classes");
    let ls_class = new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-testclass_name"})}, "kernel_unit_runner=>ty_class_item");
    ...
    for await (const unique171 of abap.statements.loop(lt_classes)) {
      ls_class.set(unique171);
      ...
      for await (const unique172 of abap.statements.loop(it_input,{where: async (I) => {return abap.compare.eq(I.class_name, ls_class.get().class_name) && abap.compare.eq(I.testclass_name, ls_class.get().testclass_name);}})) {
        ls_input.set(unique172);
...
kernel_unit_runner.ty_input = new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-testclass_name"}), "method_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-method_name"})}, "kernel_unit_runner=>ty_input_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_input");
...
kernel_unit_runner.ty_result = new abap.types.Structure({"list": new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-testclass_name"}), "method_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_input_item-method_name"}), "expected": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-EXPECTED"}), "actual": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-ACTUAL"}), "status": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_STATUS"}), "runtime": new abap.types.Integer({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-RUNTIME"}), "message": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-MESSAGE"}), "js_location": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT_ITEM-JS_LOCATION"})}, "kernel_unit_runner=>ty_result_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_result-list"), "json": new abap.types.String({qualifiedName: "KERNEL_UNIT_RUNNER=>TY_RESULT-JSON"})}, "kernel_unit_runner=>ty_result");
...
kernel_unit_runner.ty_classes = new abap.types.Table(new abap.types.Structure({"class_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-class_name"}), "testclass_name": new abap.types.Character(30, {"qualifiedName":"kernel_unit_runner=>ty_class_item-testclass_name"})}, "kernel_unit_runner=>ty_class_item"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "kernel_unit_runner=>ty_classes");
