...
class zcx_aff_tools extends cx_static_check {
  ...
  async constructor_(INPUT) {
    ...
    this.me.set(this);
    this.if_t100_dyn_msg$msgty = new abap.types.Character(1, {"qualifiedName":"SYMSGTY"});
    this.if_t100_dyn_msg$msgv1 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    this.if_t100_dyn_msg$msgv2 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    this.if_t100_dyn_msg$msgv3 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    this.if_t100_dyn_msg$msgv4 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    this.if_t100_message$t100key = new abap.types.Structure({"msgid": new abap.types.Character(20, {}), "msgno": new abap.types.Numc({length: 3}), "attr1": new abap.types.Character(255, {}), "attr2": new abap.types.Character(255, {}), "attr3": new abap.types.Character(255, {}), "attr4": new abap.types.Character(255, {})}, "SCX_T100KEY");
