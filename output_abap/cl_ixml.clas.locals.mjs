...
class lcl_escape {
  ...
  static async unescape_value(INPUT) {
    ...
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 1}).set('&'),of: new abap.types.Character({length: 5}).set('&amp;')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 1}).set('<'),of: new abap.types.Character({length: 4}).set('&lt;')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 1}).set('>'),of: new abap.types.Character({length: 4}).set('&gt;')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 1}).set('"'),of: new abap.types.Character({length: 6}).set('&quot;')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.String().set(`'`),of: new abap.types.Character({length: 6}).set('&apos;')});
    return rv_value;
  }
  ...
  static async escape_value(INPUT) {
    ...
    if (INPUT && INPUT.iv_value) {iv_value.set(INPUT.iv_value);}
    rv_value.set(iv_value);
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 5}).set('&amp;'),of: new abap.types.Character({length: 1}).set('&')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 4}).set('&lt;'),of: new abap.types.Character({length: 1}).set('<')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 4}).set('&gt;'),of: new abap.types.Character({length: 1}).set('>')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 6}).set('&quot;'),of: new abap.types.Character({length: 1}).set('"')});
    abap.statements.replace({target:rv_value, all:true, with: new abap.types.Character({length: 6}).set('&apos;'),of: new abap.types.String().set(`'`)});
    return rv_value;
  }
}
...
class lcl_named_node_map {
  ...
  async if_ixml_named_node_map$get_named_item_ns(INPUT) {
    ...
    for await (const unique90 of abap.statements.loop(this.mt_list)) {
      li_node.set(unique90);
...
class lcl_node {
  ...
  async if_ixml_element$find_from_name_ns(INPUT) {
    ...
    for await (const unique91 of abap.statements.loop(lt_nodes)) {
      li_top.set(unique91);
