...
class cl_oauth2_client {
  ...
  static METHODS = {"CREATE": {"visibility": "U", "parameters": {"RO_OAUTH2_CLIENT": {"type": () => {return new abap.types.ABAPObject({qualifiedName: "IF_OAUTH2_CLIENT", RTTIName: "\\INTERFACE=IF_OAUTH2_CLIENT"});}, "is_optional": " "}, "I_PROFILE": {"type": () => {return new abap.types.Character(30, {"qualifiedName":"OA2C_PROFILE","ddicName":"OA2C_PROFILE"});}, "is_optional": " "}, "I_CONFIGURATION": {"type": () => {return new abap.types.Character(32, {"qualifiedName":"OA2C_CONFIGURATION","ddicName":"OA2C_CONFIGURATION"});}, "is_optional": " "}}}};
  constructor() {
  ...
  async if_oauth2_client$execute_cc_flow() {
    ...
    try {
      ...
      if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
        const unique260 = await (new abap.Classes['CX_OA2C']()).constructor_();
        unique260.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 70};
        throw unique260;
      }
      ...
      try {
        ...
        if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
          const unique261 = await (new abap.Classes['CX_OA2C']()).constructor_();
          unique261.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 99};
          throw unique261;
        }
        try {
          ...
          if (abap.compare.ne(abap.builtin.sy.get().subrc, abap.IntegerFactory.get(0))) {
            ...
            const unique262 = await (new abap.Classes['CX_OA2C']()).constructor_();
            unique262.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 113};
            throw unique262;
          }
          ...
          if (abap.compare.ne(lv_code, abap.IntegerFactory.get(200))) {
            const unique263 = await (new abap.Classes['CX_OA2C']()).constructor_();
            unique263.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 121};
            throw unique263;
          }
        ...
        async if_oauth2_client$set_token(INPUT) {
          ...
          if (abap.compare.initial(this.mv_token)) {
            const unique264 = await (new abap.Classes['CX_OA2C_AT_NOT_AVAILABLE']()).constructor_();
            unique264.EXTRA_CX = {"INTERNAL_FILENAME": "cl_oauth2_client.clas.abap","INTERNAL_LINE": 131};
            throw unique264;
          }
