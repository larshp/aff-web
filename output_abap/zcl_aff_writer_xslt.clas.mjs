...
class zcl_aff_writer_xslt extends zcl_aff_writer {
  ...
  async open_structure(INPUT) {
    ...
    let temp1 = new abap.types.Structure({"name": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER=>TY_STRUCTURE_STACK-NAME"}), "absolute_name": new abap.types.Character(200, {"qualifiedName":"abap_abstypename"})}, "zcl_aff_writer=>ty_structure_stack");
    ...
    abap.statements.insertInternal({data: temp1, index: new abap.types.Integer().set(1), table: this.me.get().stack_of_structure});
  }
  async write_open_structure(INPUT) {
    ...
    abap.statements.insertInternal({data: temp2, index: new abap.types.Integer().set(1), table: this.me.get().stack_default_comp_of_struc});
  ...
  async set_abapdoc_fullname_element(INPUT) {
    ...
    if (abap.compare.eq(this.next_tag_without_name_and_ref, abap.builtin.abap_true)) {
      ...
      abap.statements.readTable(splitted_absolute_name,{index: new abap.types.Integer().set(1),into: temp1});
      ...
      abap.statements.readTable(splitted_absolute_name,{index: new abap.types.Integer().set(2),into: temp3});
  ...
  async get_tag_from_type(INPUT) {
    ...
    let unique67 = json_type;
    if (abap.compare.eq(unique67, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().string) || abap.compare.eq(unique67, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().date_time)) {
      result.set(new abap.types.String().set(`str`));
    } else if (abap.compare.eq(unique67, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().boolean)) {
      result.set(new abap.types.String().set(`bool`));
    } else if (abap.compare.eq(unique67, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().numeric)) {
      result.set(new abap.types.String().set(`num`));
    } else {
      temp7.set(json_type);
      msg.set((await this.log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(102), msgv1: temp7})));
  ...
  async get_option(INPUT) {
    ...
    if (abap.compare.eq((await this.is_sy_langu({element_description: element_description})), abap.builtin.abap_true)) {
      ...
      let unique68 = json_type;
      if (abap.compare.eq(unique68, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().string)) {
        result.set(abap.builtin.space);
      } else if (abap.compare.eq(unique68, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().date_time)) {
        result.set(new abap.types.String().set(` option="format(dateTimeOffset)"`));
      } else if (abap.compare.eq(unique68, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().boolean)) {
        result.set(new abap.types.String().set(` option="format(boolean)"`));
      } else if (abap.compare.eq(unique68, abap.Classes['ZIF_AFF_WRITER'].zif_aff_writer$type_info.get().numeric)) {
        result.set(new abap.types.String().set(` option="format(alpha)"`));
      } else {
        temp9.set(json_type);
        msg.set((await this.log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(102), msgv1: temp9})));
  ...
  async write_enum_value_mappings(INPUT) {
    ...
    if (abap.compare.eq(abap.builtin.lines({val: enum_values}), new abap.types.Integer().set(0))) {
      return;
    }
    ...
    index.set(new abap.types.Integer().set(1));
    for await (const unique69 of abap.statements.loop(enum_values)) {
      fs_enum_value_.assign(unique69);
  ...
  async get_abap_value(INPUT) {
    ...
    let unique70 = element_description.get().type_kind;
    if (abap.compare.eq(unique70, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int) || abap.compare.eq(unique70, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int1) || abap.compare.eq(unique70, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int2) || abap.compare.eq(unique70, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int8)) {
    ...
    } else if (abap.compare.eq(unique70, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_num)) {
  ...
  async get_default(INPUT) {
    ...
    if (abap.compare.initial(default_) === false) {
      ...
      abap.statements.readTable(this.stack_default_comp_of_struc,{index: new abap.types.Integer().set(1),into: temp5});
      ...
      abap.statements.readTable(this.stack_default_comp_of_struc,{index: new abap.types.Integer().set(1),assigning: fs_temp12_});
  ...
  async get_enum_values(INPUT) {
    ...
    let temp14 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let temp7 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    let msg = new abap.types.String({qualifiedName: "STRING"});
    ...
    if (abap.compare.initial(structure_of_values) === false) {
      ...
      for await (const unique71 of abap.statements.loop(structure_of_values.get().components)) {
        fs_component_.assign(unique71);
        ...
        if (abap.compare.ne(fs_component_.get().type_kind, enum_type)) {
          ...
          msg.set((await this.log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(122), msgv1: temp14, msgv2: temp7})));
  ...
  async write_tag(INPUT) {
    ...
    if (abap.compare.initial(this.ignore_til_indent_level) || abap.compare.gt(abap.operators.minus(this.ignore_til_indent_level,new abap.types.Integer().set(1)), this.indent_level)) {
  ...
  async get_default_value_from_default(INPUT) {
    ...
    if (abap.compare.eq(element_description.get().type_kind, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_utclong)) {
      message.set((await this.log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(117), msgv1: new abap.types.String().set(`UTCLONG`)})));
  ...
  async get_prefixed_default(INPUT) {
    ...
    let unique72 = element_description.get().type_kind;
    if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int) || abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int1) || abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int2)) {
    ...
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_int8)) {
      result.set(new abap.types.String().set(`INT8(${abap.templateFormatting(value)})`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_float)) {
      result.set(new abap.types.String().set(`F('${abap.templateFormatting(value)}')`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_xstring) || abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_hex)) {
      result.set(new abap.types.String().set(`X('${abap.templateFormatting(value)}')`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_decfloat16)) {
      result.set(new abap.types.String().set(`DECFLOAT16('${abap.templateFormatting(value)}')`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_decfloat34)) {
    ...
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_num)) {
      result.set(new abap.types.String().set(`N('${abap.templateFormatting(value)}')`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_char) || abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_string)) {
      result.set(new abap.types.String().set(`C('${abap.templateFormatting(value)}')`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_date)) {
      result.set(new abap.types.String().set(`D('${abap.templateFormatting(value)}')`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_time)) {
      result.set(new abap.types.String().set(`T('${abap.templateFormatting(value)}')`));
    } else if (abap.compare.eq(unique72, abap.Classes['CL_ABAP_TYPEDESCR'].typekind_utclong)) {
      message.set((await this.log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(117), msgv1: new abap.types.String().set(`UTCLONG`)})));
  ...
  async write_defaults() {
    ...
    abap.statements.readTable(this.me.get().stack_default_comp_of_struc,{index: new abap.types.Integer().set(1),into: temp9});
    abap.builtin.sy.get().tabix.set(temp10);
    if (abap.compare.ne(abap.builtin.sy.get().subrc, new abap.types.Integer().set(0))) {
      throw await (new abap.Classes['CX_SY_ITAB_LINE_NOT_FOUND']()).constructor_();
    }
    actual_entry.set(temp9);
    for await (const unique73 of abap.statements.loop(actual_entry.get().table_of_defaults)) {
      fs_default_.assign(unique73);
    ...
    abap.statements.insertInternal({lines: true, data: list_of_applies, index: abap.operators.add(actual_entry.get().line_to_insert,new abap.types.Integer().set(1)), table: this.content});
    await abap.statements.deleteInternal(this.me.get().stack_default_comp_of_struc,{index: new abap.types.Integer().set(1)});
  }
  async write_callback_template(INPUT) {
    ...
    if (abap.compare.gt(this.indent_level, new abap.types.Integer().set(0))) {
    ...
    let unique74 = description.get().kind;
    if (abap.compare.eq(unique74, abap.Classes['CL_ABAP_TYPEDESCR'].kind_elem)) {
    ...
    } else if (abap.compare.eq(unique74, abap.Classes['CL_ABAP_TYPEDESCR'].kind_struct)) {
      component_start.set(new abap.types.String().set(`<object>`));
      component_end.set(new abap.types.String().set(`</object>`));
    } else if (abap.compare.eq(unique74, abap.Classes['CL_ABAP_TYPEDESCR'].kind_table)) {
    ...
    this.ignore_til_indent_level.set(abap.operators.add(this.indent_level,new abap.types.Integer().set(1)));
  }
  ...
  async reset_indent_level_tag() {
    if (abap.compare.eq(abap.operators.minus(this.ignore_til_indent_level,new abap.types.Integer().set(1)), this.indent_level)) {
  ...
  async zif_aff_writer$validate(INPUT) {
    ...
    let tsource = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "O2PAGELINE_TABLE");
    let errors = new abap.types.Table(new abap.types.Structure({"text": new abap.types.String({qualifiedName: "CL_O2_API_XSLTDESC=>TY_ERROR-TEXT"})}, "cl_o2_api_xsltdesc=>ty_error"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "cl_o2_api_xsltdesc=>ty_error_tab");
    ...
    if (abap.compare.gt(abap.builtin.lines({val: errors}), new abap.types.Integer().set(0)) || abap.compare.initial(exception) === false) {
      for await (const unique75 of abap.statements.loop(errors)) {
        fs_error_.assign(unique75);
        await abap.Classes['CL_MESSAGE_HELPER'].set_msg_vars_for_clike({text: fs_error_.get().text});
        msg.set((await log.get().zif_aff_log$get_message_text({msgno: new abap.types.Integer().set(0), msgv1: abap.builtin.sy.get().msgv1, msgv2: abap.builtin.sy.get().msgv2, msgv3: abap.builtin.sy.get().msgv3, msgv4: abap.builtin.sy.get().msgv4})));
  ...
  async enable_extension(INPUT) {
    ...
    let component = new abap.types.Structure({"name": new abap.types.String({qualifiedName: "NAME"}), "type": new abap.types.ABAPObject({qualifiedName: "CL_ABAP_DATADESCR"}), "as_include": new abap.types.Character(1, {"qualifiedName":"ABAP_BOOL","ddicName":"ABAP_BOOL"}), "suffix": new abap.types.String({qualifiedName: "SUFFIX"})}, "abap_componentdescr");
    ...
    for await (const unique76 of abap.statements.loop(components)) {
      component.set(unique76);
...
zcl_aff_writer_xslt.tt_components_with_default = new abap.types.Table(new abap.types.Structure({"line_to_insert": new abap.types.Integer({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_COMPONENTS_WITH_DEFAULT-LINE_TO_INSERT"}), "table_of_defaults": new abap.types.Table(new abap.types.Structure({"var_name": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_VARIABLE_DEFAULT_PAIR-VAR_NAME"}), "default_value": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_VARIABLE_DEFAULT_PAIR-DEFAULT_VALUE"})}, "zcl_aff_writer_xslt=>ty_variable_default_pair"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "zcl_aff_writer_xslt=>tt_variable_default_pair")}, "zcl_aff_writer_xslt=>ty_components_with_default"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "zcl_aff_writer_xslt=>tt_components_with_default");
zcl_aff_writer_xslt.ty_enum_value = new abap.types.Structure({"abap_value": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_ENUM_VALUE-ABAP_VALUE"}), "json_value": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_ENUM_VALUE-JSON_VALUE"}), "overwritten_json_value": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_ENUM_VALUE-OVERWRITTEN_JSON_VALUE"})}, "zcl_aff_writer_xslt=>ty_enum_value");
zcl_aff_writer_xslt.tt_enum_values = new abap.types.Table(new abap.types.Structure({"abap_value": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_ENUM_VALUE-ABAP_VALUE"}), "json_value": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_ENUM_VALUE-JSON_VALUE"}), "overwritten_json_value": new abap.types.String({qualifiedName: "ZCL_AFF_WRITER_XSLT=>TY_ENUM_VALUE-OVERWRITTEN_JSON_VALUE"})}, "zcl_aff_writer_xslt=>ty_enum_value"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "zcl_aff_writer_xslt=>tt_enum_values");
