...
class cl_bcs_convert {
  ...
  static async string_to_soli(INPUT) {
    let et_soli = new abap.types.Table(new abap.types.Structure({"line": new abap.types.Character(255, {"qualifiedName":"SO_TEXT255","ddicName":"SO_TEXT255"})}, "SOLI"), {"withHeader":false}, "SOLI_TAB");
