...
class zcl_aff_log {
  ...
  async add_message(INPUT) {
    let type = new abap.types.Character(1, {"qualifiedName":"SYMSGTY"});
  ...
  async add_message_for_exception(INPUT) {
    let type = new abap.types.Character(1, {"qualifiedName":"SYMSGTY"});
    if (INPUT && INPUT.type) {type = INPUT.type;}
    let message = new abap.types.Structure({"msgty": new abap.types.Character(1, {}), "msgid": new abap.types.Character(20, {}), "msgno": new abap.types.Numc({length: 3}), "msgv1": new abap.types.Character(50, {}), "msgv2": new abap.types.Character(50, {}), "msgv3": new abap.types.Character(50, {}), "msgv4": new abap.types.Character(50, {})}, "SYMSG");
  ...
  async constructor_(INPUT) {
    ...
    this.me.set(this);
    this.messages = new abap.types.Table(new abap.types.Structure({"component_name": new abap.types.String({qualifiedName: "ZIF_AFF_LOG=>TY_LOG_OUT-COMPONENT_NAME"}), "type": new abap.types.Character(1, {"qualifiedName":"SYMSGTY"}), "message_text": new abap.types.String({qualifiedName: "ZIF_AFF_LOG=>TY_LOG_OUT-MESSAGE_TEXT"}), "message": new abap.types.Structure({"msgty": new abap.types.Character(1, {}), "msgid": new abap.types.Character(20, {}), "msgno": new abap.types.Numc({length: 3}), "msgv1": new abap.types.Character(50, {}), "msgv2": new abap.types.Character(50, {}), "msgv3": new abap.types.Character(50, {}), "msgv4": new abap.types.Character(50, {})}, "SYMSG")}, "zif_aff_log=>ty_log_out"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "zif_aff_log=>tt_log_out");
    this.message_table = new abap.types.Table(new abap.types.Structure({"msgno": new abap.types.Integer({qualifiedName: "ZCL_AFF_LOG=>TY_MSG-MSGNO"}), "str1": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str1"}), "str2": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str2"}), "str3": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str3"}), "str4": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str4"})}, "zcl_aff_log=>ty_msg"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "zcl_aff_log=>tt_msg");
    this.max_severity = new abap.types.Character(1, {"qualifiedName":"SYMSGTY"});
    let temp3 = new abap.types.Structure({"msgno": new abap.types.Integer({qualifiedName: "ZCL_AFF_LOG=>TY_MSG-MSGNO"}), "str1": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str1"}), "str2": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str2"}), "str3": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str3"}), "str4": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str4"})}, "zcl_aff_log=>ty_msg");
    ...
    temp3.get().msgno.set(new abap.types.Integer().set(0));
    abap.statements.append({source: temp3, target: this.message_table});
    abap.statements.clear(temp4);
    temp4.get().msgno.set(new abap.types.Integer().set(102));
    ...
    temp5.get().msgno.set(new abap.types.Integer().set(103));
    ...
    temp6.get().msgno.set(new abap.types.Integer().set(104));
    ...
    temp7.get().msgno.set(new abap.types.Integer().set(105));
    ...
    temp8.get().msgno.set(new abap.types.Integer().set(107));
    ...
    temp9.get().msgno.set(new abap.types.Integer().set(108));
    ...
    temp10.get().msgno.set(new abap.types.Integer().set(109));
    ...
    temp11.get().msgno.set(new abap.types.Integer().set(110));
    ...
    temp12.get().msgno.set(new abap.types.Integer().set(111));
    ...
    temp13.get().msgno.set(new abap.types.Integer().set(112));
    ...
    temp14.get().msgno.set(new abap.types.Integer().set(117));
    ...
    temp15.get().msgno.set(new abap.types.Integer().set(119));
    ...
    temp16.get().msgno.set(new abap.types.Integer().set(122));
    ...
    temp17.get().msgno.set(new abap.types.Integer().set(125));
  ...
  static async get_sy_message() {
    let result = new abap.types.Structure({"msgty": new abap.types.Character(1, {}), "msgid": new abap.types.Character(20, {}), "msgno": new abap.types.Numc({length: 3}), "msgv1": new abap.types.Character(50, {}), "msgv2": new abap.types.Character(50, {}), "msgv3": new abap.types.Character(50, {}), "msgv4": new abap.types.Character(50, {})}, "SYMSG");
  ...
  async zif_aff_log$add_exception(INPUT) {
    ...
    let message_type = new abap.types.Character(1, {"qualifiedName":"SYMSGTY"});
  ...
  async zif_aff_log$get_message_text(INPUT) {
    ...
    let msgv1 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    if (INPUT && INPUT.msgv1) {msgv1.set(INPUT.msgv1);}
    let msgv2 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    if (INPUT && INPUT.msgv2) {msgv2.set(INPUT.msgv2);}
    let msgv3 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    if (INPUT && INPUT.msgv3) {msgv3.set(INPUT.msgv3);}
    let msgv4 = new abap.types.Character(50, {"qualifiedName":"SYMSGV"});
    ...
    if (abap.compare.eq(temp18, new abap.types.Integer().set(0))) {
...
zcl_aff_log.tt_msg = new abap.types.Table(new abap.types.Structure({"msgno": new abap.types.Integer({qualifiedName: "ZCL_AFF_LOG=>TY_MSG-MSGNO"}), "str1": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str1"}), "str2": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str2"}), "str3": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str3"}), "str4": new abap.types.Character(50, {"qualifiedName":"zcl_aff_log=>ty_msg-str4"})}, "zcl_aff_log=>ty_msg"), {"withHeader":false,"primaryKey":{"name":"primary_key","type":"STANDARD","isUnique":false,"keyFields":[]},"secondary":[]}, "zcl_aff_log=>tt_msg");
export {zcl_aff_log};
