...
class cl_shm_area extends cx_shm_general_error {
  ...
  async constructor_(INPUT) {
    ...
    this.me.set(this);
    this.properties = new abap.types.Structure({"auto_build": new abap.types.Character(1, {}), "has_versions": new abap.types.Character(1, {})}, "SHM_PROPERTIES");
    this.inst_name = new abap.types.Character(80, {"qualifiedName":"SHM_INST_NAME"});
    this.client = new abap.types.Character(3, {"qualifiedName":"MANDT"});
  ...
  static async _free_instance71(INPUT) {
    ...
    let inst_name = new abap.types.Character(80, {"qualifiedName":"SHM_INST_NAME"});
    if (INPUT && INPUT.inst_name) {inst_name.set(INPUT.inst_name);}
    let client = new abap.types.Character(3, {"qualifiedName":"SHM_CLIENT"});
...
cl_shm_area.default_instance = new abap.types.Character(80, {"qualifiedName":"SHM_INST_NAME"});
