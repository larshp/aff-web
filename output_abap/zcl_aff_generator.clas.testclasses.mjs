...
abap.Classes['CLAS-ZCL_AFF_GENERATOR-LIF_TEST_TYPES'] = lif_test_types;class ltcl_unit_test_writer extends zcl_aff_writer {
  ...
  async write_element(INPUT) {
    ...
    temp11.set(new abap.types.String().set(`${abap.templateFormatting(abap.builtin.repeat({val: new abap.types.String().set(` `), occ: abap.operators.multiply(constant_4,this.depth)}))}${abap.templateFormatting(element_name)} : ${abap.templateFormatting(element_description.get().type_kind)}`));
  ...
  async close_structure(INPUT) {
    ...
    temp12.set(new abap.types.String().set(`${abap.templateFormatting(abap.builtin.repeat({val: new abap.types.String().set(` `), occ: abap.operators.multiply(constant_4,abap.operators.minus(this.depth,constant_1))}))}CLOSE_STRUCTURE ${abap.templateFormatting(structure_name)}`));
    abap.statements.append({source: temp12, target: this.output});
    this.depth.set(abap.operators.minus(this.depth,constant_1));
  }
  async close_table(INPUT) {
    ...
    temp13.set(new abap.types.String().set(`${abap.templateFormatting(abap.builtin.repeat({val: new abap.types.String().set(` `), occ: abap.operators.multiply(constant_4,abap.operators.minus(this.depth,constant_1))}))}CLOSE_TABLE ${abap.templateFormatting(table_name)}`));
  ...
  async open_structure(INPUT) {
    ...
    temp14.set(new abap.types.String().set(`${abap.templateFormatting(abap.builtin.repeat({val: new abap.types.String().set(` `), occ: abap.operators.multiply(constant_4,this.depth)}))}OPEN_STRUCTURE ${abap.templateFormatting(structure_name)}`));
    abap.statements.append({source: temp14, target: this.output});
    this.depth.set(abap.operators.add(this.depth,constant_1));
  }
  async open_table(INPUT) {
    ...
    temp15.set(new abap.types.String().set(`${abap.templateFormatting(abap.builtin.repeat({val: new abap.types.String().set(` `), occ: abap.operators.multiply(constant_4,this.depth)}))}OPEN_TABLE ${abap.templateFormatting(table_name)}`));
...
class ltcl_type_generator {
  ...
  async table_build_in_type() {
    let table_build_in_type = new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_build_in_type");
    let act_result = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "STRING_TABLE");
  ...
  async table_structure() {
    let table_structure = new abap.types.Table(new abap.types.Structure({element_1: new abap.types.Integer({qualifiedName: "LIF_TEST_TYPES=>STRUCTURE-ELEMENT_1"}), element_2: new abap.types.String({qualifiedName: "LIF_TEST_TYPES=>ELEMENT"})}, "lif_test_types=>structure"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_structure");
    let act_result = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "STRING_TABLE");
  ...
  async structure_with_table() {
    let structure_with_table = new abap.types.Structure({table: new abap.types.Table(new abap.types.Structure({element_1: new abap.types.Integer({qualifiedName: "LIF_TEST_TYPES=>STRUCTURE-ELEMENT_1"}), element_2: new abap.types.String({qualifiedName: "LIF_TEST_TYPES=>ELEMENT"})}, "lif_test_types=>structure"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_structure")}, "lif_test_types=>structure_with_table");
    let act_result = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "STRING_TABLE");
  ...
  async include_table() {
    let include_table = new abap.types.Structure({table: new abap.types.Table(new abap.types.Structure({element_1: new abap.types.Integer({qualifiedName: "LIF_TEST_TYPES=>STRUCTURE-ELEMENT_1"}), element_2: new abap.types.String({qualifiedName: "LIF_TEST_TYPES=>ELEMENT"})}, "lif_test_types=>structure"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_structure"), include_element_1: new abap.types.Integer({qualifiedName: "LIF_TEST_TYPES=>INCLUDE_TABLE-INCLUDE_ELEMENT_1"})}, "lif_test_types=>include_table");
    let act_result = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "STRING_TABLE");
  ...
  async table_in_table() {
    let table_in_table = new abap.types.Table(new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_build_in_type"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_in_table");
    let act_result = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "STRING_TABLE");
  ...
  async struc_tab_struc_tab() {
    let struc_tab_struc_tab = new abap.types.Structure({first_table: new abap.types.Table(new abap.types.Structure({second_table: new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_build_in_type")}, "lif_test_types=>nested_table"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>first_table_type")}, "lif_test_types=>struc_tab_struc_tab");
    let act_result = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "STRING_TABLE");
  ...
  async unsupported_type() {
    ...
    try {
      ...
      await abap.Classes['CL_ABAP_UNIT_ASSERT'].fail({msg: new abap.types.Character({length: 18}).set('Exception expected')});
    } catch (e) {
  ...
  async complex_structure_aff_class() {
    let aff_class = new abap.types.Structure({format_version: new abap.types.String({qualifiedName: "LIF_TEST_TYPES=>TY_CLASS_PROPERTIES-FORMAT_VERSION"}), header: new abap.types.Structure({description: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_header-description"})}, "lif_test_types=>ty_header"), category: new abap.types.Numc({length: 2, qualifiedName: "lif_test_types=>ty_class_properties-category"}), fixpt: new abap.types.Character({qualifiedName: "lif_test_types=>ty_class_properties-fixpt"}), msg_id: new abap.types.Character({length: 20, qualifiedName: "lif_test_types=>ty_class_properties-msg_id"}), attributes: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_component-name"}), description: new abap.types.Character({length: 60, qualifiedName: "lif_test_types=>ty_component-description"})}, "lif_test_types=>ty_component"), {"withHeader":false,"type":"SORTED","isUnique":true,"keyFields":["NAME"]}, "lif_test_types=>ty_components"), methods: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_method-name"}), description: new abap.types.Character({length: 60, qualifiedName: "lif_test_types=>ty_method-description"}), parameters: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_component-name"}), description: new abap.types.Character({length: 60, qualifiedName: "lif_test_types=>ty_component-description"})}, "lif_test_types=>ty_component"), {"withHeader":false,"type":"SORTED","isUnique":true,"keyFields":["NAME"]}, "lif_test_types=>ty_subcomponents"), exceptions: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_component-name"}), description: new abap.types.Character({length: 60, qualifiedName: "lif_test_types=>ty_component-description"})}, "lif_test_types=>ty_component"), {"withHeader":false,"type":"SORTED","isUnique":true,"keyFields":["NAME"]}, "lif_test_types=>ty_subcomponents")}, "lif_test_types=>ty_method"), {"withHeader":false,"type":"SORTED","isUnique":true,"keyFields":["NAME"]}, "lif_test_types=>ty_methods"), events: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_event-name"}), description: new abap.types.Character({length: 60, qualifiedName: "lif_test_types=>ty_event-description"}), parameters: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_component-name"}), description: new abap.types.Character({length: 60, qualifiedName: "lif_test_types=>ty_component-description"})}, "lif_test_types=>ty_component"), {"withHeader":false,"type":"SORTED","isUnique":true,"keyFields":["NAME"]}, "lif_test_types=>ty_subcomponents")}, "lif_test_types=>ty_event"), {"withHeader":false,"type":"SORTED","isUnique":true,"keyFields":["NAME"]}, "lif_test_types=>ty_events"), types: new abap.types.Table(new abap.types.Structure({name: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_component-name"}), description: new abap.types.Character({length: 60, qualifiedName: "lif_test_types=>ty_component-description"})}, "lif_test_types=>ty_component"), {"withHeader":false,"type":"SORTED","isUnique":true,"keyFields":["NAME"]}, "lif_test_types=>ty_components")}, "lif_test_types=>ty_class_properties");
    let act_result = new abap.types.Table(new abap.types.String(), {"withHeader":false}, "STRING_TABLE");
  ...
  async mandatory_fields() {
    let abap_type = new abap.types.Structure({format_version: new abap.types.String({qualifiedName: "LIF_TEST_TYPES=>TY_ABAP_TYPE-FORMAT_VERSION"}), header: new abap.types.Structure({description: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_header-description"})}, "lif_test_types=>ty_header"), other_component: new abap.types.Integer({qualifiedName: "LIF_TEST_TYPES=>TY_ABAP_TYPE-OTHER_COMPONENT"})}, "lif_test_types=>ty_abap_type");
  ...
  async no_format_version() {
    let no_format_version = new abap.types.Structure({header: new abap.types.Structure({description: new abap.types.Character({length: 30, qualifiedName: "lif_test_types=>ty_header-description"})}, "lif_test_types=>ty_header"), other_component: new abap.types.Integer({qualifiedName: "LIF_TEST_TYPES=>TY_ABAP_TYPE_NO_FORMAT-OTHER_COMPONENT"})}, "lif_test_types=>ty_abap_type_no_format");
    let log = new abap.types.ABAPObject({qualifiedName: "ZIF_AFF_LOG"});
  ...
  async no_structure() {
    let no_structure = new abap.types.Table(new abap.types.Table(new abap.types.String({qualifiedName: "STRING"}), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_build_in_type"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "lif_test_types=>table_in_table");
    let log = new abap.types.ABAPObject({qualifiedName: "ZIF_AFF_LOG"});
