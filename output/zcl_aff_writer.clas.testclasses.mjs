...
class ltcl_type_writer {
  ...
  async camel_case() {
    ...
    act_name.set((await this.cut.get().format_name({name: new abap.types.Character({length: 12}).set('MY_TEst_nAmE')})));
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({act: act_name, exp: new abap.types.Character({length: 10}).set('myTestName'), msg: new abap.types.String().set(`Actual was ${abap.templateFormatting(act_name)}, but expected is 'myTestName'`)});
  }
  async get_type_info_string_like_enum() {
    ...
    undefined.get().option1.set(new abap.types.Character({length: 1}).set('1'));
    undefined.get().option2.set(new abap.types.Character({length: 1}).set('2'));
  ...
  async get_type_info_string_like() {
    ...
    let temp46 = new abap.types.Character({qualifiedName: "CHAR1"});
  ...
  async get_type_info_boolean1() {
    let temp49 = new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"});
  ...
  async get_type_info_boolean2() {
    let temp50 = new abap.types.Character({qualifiedName: "ABAP_BOOL"});
  ...
  async get_type_info_boolean3() {
    let temp51 = new abap.types.Character({qualifiedName: "FLAG"});
  ...
  async stack_stores_operations() {
    let table = new abap.types.Table(new abap.types.Structure({pgmid: new abap.types.Character({length: 4, qualifiedName: "TADIR-PGMID"}), object: new abap.types.Character({length: 4, qualifiedName: "TADIR-OBJECT"}), obj_name: new abap.types.Character({length: 40, qualifiedName: "TADIR-OBJ_NAME"}), devclass: new abap.types.Character({length: 30, qualifiedName: "TADIR-DEVCLASS"}), korrnum: new abap.types.Character({length: 10, qualifiedName: "TADIR-KORRNUM"}), delflag: new abap.types.Character({qualifiedName: "TADIR-DELFLAG"}), genflag: new abap.types.Character({qualifiedName: "TADIR-GENFLAG"}), srcsystem: new abap.types.Character({length: 5, qualifiedName: "TADIR-SRCSYSTEM"})}, "TADIR"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "");
    ...
    await this.cut.get().zif_aff_writer$write_element({element_name: new abap.types.Character({length: 13}).set('write_element'), element_description: temp63});
    ...
    await this.cut.get().zif_aff_writer$open_node({node_name: new abap.types.Character({length: 14}).set('open_structure'), node_description: (await abap.Classes['CL_ABAP_TYPEDESCR'].describe_by_data({p_data: temp64}))});
    ...
    await this.cut.get().zif_aff_writer$close_node({node_name: new abap.types.Character({length: 15}).set('close_structure'), node_description: (await abap.Classes['CL_ABAP_TYPEDESCR'].describe_by_data({p_data: temp65}))});
    ...
    await this.cut.get().zif_aff_writer$open_node({node_name: new abap.types.Character({length: 10}).set('open_table'), node_description: (await abap.Classes['CL_ABAP_TYPEDESCR'].describe_by_data({p_data: table}))});
    ...
    await this.cut.get().zif_aff_writer$close_node({node_name: new abap.types.Character({length: 11}).set('close_table'), node_description: (await abap.Classes['CL_ABAP_TYPEDESCR'].describe_by_data({p_data: table}))});
  ...
  async append_to_previous_line() {
    ...
    await this.cut.get().append_to_previous_line({string: new abap.types.Character({length: 3}).set('1+2')});
    await this.cut.get().append_to_previous_line({string: new abap.types.Character({length: 1}).set('=')});
    await this.cut.get().append_to_previous_line({string: new abap.types.Character({length: 3}).set('2+1')});
    await this.cut.get().write_tag({line: new abap.types.Character({length: 8}).set('new line')});
    await this.cut.get().append_to_previous_line({string: new abap.types.Character({length: 1}).set(';')});
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: constant_2, act: abap.builtin.lines({val: this.cut.get().content})});
    temp68.set(abap.builtin.sy.get().tabix);
    abap.statements.readTable(this.cut.get().content,{index: constant_1,into: temp67});
    ...
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: new abap.types.Character({length: 7}).set('1+2=2+1'), act: temp67});
    temp70.set(abap.builtin.sy.get().tabix);
    abap.statements.readTable(this.cut.get().content,{index: constant_2,into: temp69});
    abap.builtin.sy.get().tabix.set(temp70);
    if (abap.compare.ne(abap.builtin.sy.get().subrc, constant_0)) {
      throw await (new abap.Classes['CX_SY_ITAB_LINE_NOT_FOUND']()).constructor_();
    }
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: new abap.types.Character({length: 9}).set('new line;'), act: temp69});
  }
  async call_reader_and_decode1() {
    let name_of_source = new abap.types.String({qualifiedName: "STRING"});
    let element_name = new abap.types.String({qualifiedName: "STRING"});
    let abap_doc_act = new abap.types.Structure({required: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), showalways: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), title: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-TITLE"}), description: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DESCRIPTION"}), enumvalues_link: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUMVALUES_LINK"}), minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MINIMUM"}), maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAXIMUM"}), exclusive_minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MINIMUM"}), exclusive_maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MAXIMUM"}), multiple_of: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MULTIPLE_OF"}), default_: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DEFAULT_"}), min_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MIN_LENGTH"}), max_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAX_LENGTH"}), callback_class: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-CALLBACK_CLASS"}), enum_value: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUM_VALUE"})}, "zcl_aff_abap_doc_parser=>abap_doc");
    let abap_doc_exp = new abap.types.Structure({required: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), showalways: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), title: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-TITLE"}), description: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DESCRIPTION"}), enumvalues_link: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUMVALUES_LINK"}), minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MINIMUM"}), maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAXIMUM"}), exclusive_minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MINIMUM"}), exclusive_maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MAXIMUM"}), multiple_of: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MULTIPLE_OF"}), default_: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DEFAULT_"}), min_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MIN_LENGTH"}), max_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAX_LENGTH"}), callback_class: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-CALLBACK_CLASS"}), enum_value: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUM_VALUE"})}, "zcl_aff_abap_doc_parser=>abap_doc");
  ...
  async call_reader_and_decode2() {
    ...
    abap_doc_act.set((await this.cut.get().call_reader_and_decode({name_of_source: name_of_source, element_name: element_name})));
    abap.statements.clear(abap_doc_exp);
    abap_doc_exp.get().title.set(new abap.types.Character({length: 20}).set('Title of inner_struc'));
    abap_doc_exp.get().description.set(new abap.types.Character({length: 26}).set('Description of inner_struc'));
  ...
  async call_reader_and_decode4() {
    ...
    abap_doc_act.set((await this.cut.get().call_reader_and_decode({name_of_source: name_of_source, element_name: element_name})));
    abap.statements.clear(abap_doc_exp);
    abap_doc_exp.get().title.set(new abap.types.Character({length: 33}).set('Packed Number With Given Multiple'));
  ...
  async call_reader_and_decode5() {
    ...
    abap_doc_act.set((await this.cut.get().call_reader_and_decode({name_of_source: name_of_source, element_name: element_name})));
    abap.statements.clear(abap_doc_exp);
    abap_doc_exp.get().title.set(new abap.types.Character({length: 17}).set('Four Byte Integer'));
    abap_doc_exp.get().description.set(new abap.types.Character({length: 17}).set('Four byte integer'));
    abap_doc_exp.get().default_.set(new abap.types.Character({length: 3}).set('"5"'));
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: abap_doc_exp, act: abap_doc_act});
  }
  async call_reader_and_decode6() {
    ...
    abap_doc_act.set((await this.cut.get().call_reader_and_decode({name_of_source: name_of_source, element_name: element_name})));
    abap.statements.clear(abap_doc_exp);
    abap_doc_exp.get().title.set(new abap.types.Character({length: 9}).set('Enum Type'));
    abap_doc_exp.get().description.set(new abap.types.Character({length: 9}).set('Enum type'));
    abap_doc_exp.get().enumvalues_link.set(new abap.types.Character({length: 41}).set('zcl_aff_test_types.data:co_class_category'));
    abap_doc_exp.get().default_.set(new abap.types.Character({length: 58}).set('@link zcl_aff_test_types.data:co_class_category.exit_class'));
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: abap_doc_exp, act: abap_doc_act});
  }
  async call_reader_and_decode7() {
    ...
    abap_doc_act.set((await this.cut.get().call_reader_and_decode({name_of_source: name_of_source, element_name: element_name})));
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: new abap.types.Character({length: 13}).set('First Element'), act: abap_doc_act.get().title});
  }
  async delete_first_of_struc_stack() {
    let exp_table = new abap.types.Table(new abap.types.Structure({name: new abap.types.String({qualifiedName: "ZCL_AFF_WRITER=>TY_STRUCTURE_STACK-NAME"}), absolute_name: new abap.types.Character({length: 200, qualifiedName: "abap_abstypename"})}, "zcl_aff_writer=>ty_structure_stack"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "zcl_aff_writer=>tt_structure_stack");
    let temp71 = new abap.types.Structure({name: new abap.types.String({qualifiedName: "ZCL_AFF_WRITER=>TY_STRUCTURE_STACK-NAME"}), absolute_name: new abap.types.Character({length: 200, qualifiedName: "abap_abstypename"})}, "zcl_aff_writer=>ty_structure_stack");
    let temp72 = new abap.types.Structure({name: new abap.types.String({qualifiedName: "ZCL_AFF_WRITER=>TY_STRUCTURE_STACK-NAME"}), absolute_name: new abap.types.Character({length: 200, qualifiedName: "abap_abstypename"})}, "zcl_aff_writer=>ty_structure_stack");
    let temp73 = new abap.types.Structure({name: new abap.types.String({qualifiedName: "ZCL_AFF_WRITER=>TY_STRUCTURE_STACK-NAME"}), absolute_name: new abap.types.Character({length: 200, qualifiedName: "abap_abstypename"})}, "zcl_aff_writer=>ty_structure_stack");
    ...
    abap.statements.insertInternal({data: temp71, index: constant_1, table: this.cut.get().stack_of_structure});
    ...
    abap.statements.insertInternal({data: temp72, index: constant_1, table: exp_table});
    ...
    abap.statements.insertInternal({data: temp73, index: constant_1, table: this.cut.get().stack_of_structure});
  ...
  async get_all_path_information() {
    let temp74 = new abap.types.Structure({name: new abap.types.String({qualifiedName: "ZCL_AFF_WRITER=>TY_STRUCTURE_STACK-NAME"}), absolute_name: new abap.types.Character({length: 200, qualifiedName: "abap_abstypename"})}, "zcl_aff_writer=>ty_structure_stack");
    let temp75 = new abap.types.Structure({name: new abap.types.String({qualifiedName: "ZCL_AFF_WRITER=>TY_STRUCTURE_STACK-NAME"}), absolute_name: new abap.types.Character({length: 200, qualifiedName: "abap_abstypename"})}, "zcl_aff_writer=>ty_structure_stack");
    ...
    abap.statements.insertInternal({data: temp74, index: constant_1, table: this.cut.get().stack_of_structure});
    ...
    abap.statements.insertInternal({data: temp75, index: constant_1, table: this.cut.get().stack_of_structure});
  ...
  async get_abap_doc_for_absolute_name() {
    ...
    let temp76 = new abap.types.Character({length: 200, qualifiedName: "abap_abstypename"});
    let act_abap_doc = new abap.types.Structure({required: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), showalways: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), title: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-TITLE"}), description: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DESCRIPTION"}), enumvalues_link: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUMVALUES_LINK"}), minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MINIMUM"}), maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAXIMUM"}), exclusive_minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MINIMUM"}), exclusive_maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MAXIMUM"}), multiple_of: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MULTIPLE_OF"}), default_: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DEFAULT_"}), min_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MIN_LENGTH"}), max_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAX_LENGTH"}), callback_class: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-CALLBACK_CLASS"}), enum_value: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUM_VALUE"})}, "zcl_aff_abap_doc_parser=>abap_doc");
    let exp_abap_doc = new abap.types.Structure({required: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), showalways: new abap.types.Character({qualifiedName: "ABAP_BOOL"}), title: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-TITLE"}), description: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DESCRIPTION"}), enumvalues_link: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUMVALUES_LINK"}), minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MINIMUM"}), maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAXIMUM"}), exclusive_minimum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MINIMUM"}), exclusive_maximum: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-EXCLUSIVE_MAXIMUM"}), multiple_of: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MULTIPLE_OF"}), default_: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-DEFAULT_"}), min_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MIN_LENGTH"}), max_length: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-MAX_LENGTH"}), callback_class: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-CALLBACK_CLASS"}), enum_value: new abap.types.String({qualifiedName: "ZCL_AFF_ABAP_DOC_PARSER=>ABAP_DOC-ENUM_VALUE"})}, "zcl_aff_abap_doc_parser=>abap_doc");
  ...
  async compare_abap_doc() {
    ...
    abap.statements.clear(abap_doc_base);
    abap_doc_base.get().enumvalues_link.set(new abap.types.Character({length: 14}).set('This is a link'));
    abap.statements.clear(abap_doc_additional);
  ...
  async callback_class_is_valid() {
    ...
    is_valid.set((await this.cut.get().is_callback_class_valid({class_name: class_name, component_name: new abap.types.Character({length: 14}).set('Component Name')})));
  ...
  async validate_default() {
    let table_of_tuples = new abap.types.Table(new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple"), {"withHeader":false,"type":"STANDARD","isUnique":false,"keyFields":[]}, "");
    let date_time = new abap.types.UTCLong();
    let temp78 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp22 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let time = new abap.types.Time({qualifiedName: "T"});
    let temp79 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp23 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp80 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp24 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp81 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp25 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let date = new abap.types.Date({qualifiedName: "D"});
    let temp82 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp26 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp83 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp27 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp84 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp28 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let numeric = new abap.types.Numc({length: 3});
    let temp85 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp29 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp86 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp30 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp87 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp31 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let float = new abap.types.Float({qualifiedName: "F"});
    let temp88 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp32 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp89 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp33 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let decfloat = new abap.types.typeTodoDecFloat16Type();
    let temp90 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp34 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp91 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp35 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let packed = new abap.types.Packed({length: 3, decimals: 2});
    let temp92 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp36 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp93 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp37 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp94 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp38 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let char_ = new abap.types.Character({length: 4, qualifiedName: "undefined"});
    let temp95 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp39 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp96 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp40 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let boolean = new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"});
    let temp97 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp41 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp98 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp42 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp99 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp43 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp100 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    ...
    let temp101 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp45 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let temp102 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp46 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let integer = new abap.types.Integer({qualifiedName: "I"});
    let temp103 = new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple");
    let temp47 = new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"});
    let fs_entry_ = new abap.types.FieldSymbol(new abap.types.Structure({element_description: new abap.types.ABAPObject({qualifiedName: "CL_ABAP_ELEMDESCR"}), default_: new abap.types.String({qualifiedName: "DESCR_DEFAULT_VALID_TUPLE-DEFAULT_"}), is_valid: new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"})}, "descr_default_valid_tuple"));
    let is_valid = new abap.types.Character({qualifiedName: "ABAP_BOOLEAN"});
    ...
    temp78.get().default_.set(new abap.types.Character({length: 27}).set('9999-12-31T23:59:59.9999999'));
    ...
    temp79.get().default_.set(new abap.types.Character({length: 2}).set('20'));
    ...
    temp80.get().default_.set(new abap.types.Character({length: 6}).set('201500'));
    ...
    temp81.get().default_.set(new abap.types.Character({length: 8}).set('20150045'));
    ...
    temp82.get().default_.set(new abap.types.Character({length: 8}).set('20121201'));
    ...
    temp83.get().default_.set(new abap.types.Character({length: 9}).set('201212214'));
    ...
    temp84.get().default_.set(new abap.types.Character({length: 6}).set('201212'));
    temp84.get().is_valid.set(abap.builtin.abap_true);
    abap.statements.insertInternal({data: temp84, table: table_of_tuples});
    numeric.set(new abap.types.Character({length: 2}).set('20'));
    ...
    temp85.get().default_.set(new abap.types.Character({length: 3}).set('201'));
    ...
    temp86.get().default_.set(new abap.types.Character({length: 2}).set('20'));
    ...
    temp87.get().default_.set(new abap.types.Character({length: 4}).set('2021'));
    ...
    temp88.get().default_.set(new abap.types.Character({length: 7}).set('14.5e12'));
    ...
    temp89.get().default_.set(new abap.types.Character({length: 8}).set('no float'));
    ...
    temp90.get().default_.set(new abap.types.Character({length: 7}).set('14.5e12'));
    ...
    temp91.get().default_.set(new abap.types.Character({length: 8}).set('no_float'));
    ...
    temp92.get().default_.set(new abap.types.Character({length: 1}).set('a'));
    ...
    temp93.get().default_.set(new abap.types.Character({length: 5}).set('4.534'));
    ...
    temp94.get().default_.set(new abap.types.Character({length: 4}).set('3.25'));
    ...
    temp95.get().default_.set(new abap.types.Character({length: 3}).set('a5b'));
    ...
    temp96.get().default_.set(new abap.types.Character({length: 5}).set('a5bca'));
    ...
    temp97.get().default_.set(new abap.types.Character({length: 9}).set('abap_true'));
    ...
    temp98.get().default_.set(new abap.types.Character({length: 10}).set('abap_false'));
    ...
    temp99.get().default_.set(new abap.types.Character({length: 0}).set(''));
    ...
    temp100.get().default_.set(new abap.types.Character({length: 1}).set('a'));
    ...
    temp101.get().default_.set(new abap.types.Character({length: 2}).set('-5'));
    ...
    temp102.get().default_.set(new abap.types.Character({length: 2}).set('10'));
  ...
  async handle_include() {
    ...
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: constant_1, act: abap.builtin.lines({val: this.cut.get().stack_of_structure})});
    await this.cut.get().zif_aff_writer$close_include();
    await abap.Classes['CL_ABAP_UNIT_ASSERT'].assert_equals({exp: constant_0, act: abap.builtin.lines({val: this.cut.get().stack_of_structure})});
  }
}
